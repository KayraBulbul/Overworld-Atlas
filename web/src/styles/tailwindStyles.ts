const utilities: Record<string, string> = {
  ...
  'header-inner':
    '[display:grid] [grid-template-columns:auto_1fr_auto] [align-items:center] [width:min(100%_-_2rem,_88rem)] [height:100%] [margin-inline:auto] [gap:clamp(1rem,_2vw,_2.5rem)] [border-bottom:1px_solid_var(--border)] max-[72.001rem]:[grid-template-columns:1fr_auto_auto] max-[44.001rem]:[width:min(100%_-_1.25rem,_88rem)] max-[44.001rem]:[gap:0.65rem]',
  'hero-actions':
  ...
  'menu-button':
    '[display:none] [align-items:center] [gap:0.65rem] [border:0] [background:none] [font-size:0.75rem] [font-weight:700] [letter-spacing:0.08em] [text-transform:uppercase] max-[72.001rem]:[display:flex] max-[44.001rem]:[&_>_span:first-child]:[position:absolute] max-[44.001rem]:[&_>_span:first-child]:[width:1px] max-[44.001rem]:[&_>_span:first-child]:[height:1px] max-[44.001rem]:[&_>_span:first-child]:[overflow:hidden] max-[44.001rem]:[&_>_span:first-child]:[clip:rect(0_0_0_0)] max-[44.001rem]:[&_>_span:first-child]:[white-space:nowrap]',
  'menu-lines':
    "[display:block] [width:1.4rem] [height:1px] [background:currentColor] [content:''] [&::before]:[display:block] [&::before]:[width:1.4rem] [&::before]:[height:1px] [&::before]:[background:currentColor] [&::before]:[content:''] [&::after]:[display:block] [&::after]:[width:1.4rem] [&::after]:[height:1px] [&::after]:[background:currentColor] [&::after]:[content:''] [&::before]:[transform:translateY(-0.35rem)] [&::after]:[transform:translateY(0.3rem)]",
  'nav-join':
    '[background:transparent] [font-size:0.77rem] [font-weight:700] [letter-spacing:0.08em] [text-decoration:none] [text-transform:uppercase] [padding:0.55rem_0.85rem] [border:1px_solid_var(--border-strong)] [color:var(--text)] [&:hover]:[border-color:var(--accent)] [&:hover]:[color:var(--accent-strong)] max-[72.001rem]:[height:auto] max-[72.001rem]:[padding:0.75rem] max-[72.001rem]:[text-align:left]',
  ...
  'player-avatar':
    '[display:grid] [width:2.6rem] [height:2.6rem] [place-items:center] [border:1px_solid_var(--border-strong)] [color:#fffaf1] [font-size:0.75rem] [font-weight:700] [letter-spacing:0.08em]',
  ...
  'player-location':
    '[margin:0] [color:var(--text-muted)] [font-size:0.72rem] [grid-column:1_/_-1] [margin-left:3.25rem] [margin-top:-0.55rem]',
  'player-preview':
  ...
  'player-record':
    '[display:grid] [grid-template-columns:3rem_auto_minmax(12rem,_0.65fr)_minmax(28rem,_1fr)] [align-items:center] [padding-block:1.3rem] [gap:clamp(1rem,_3vw,_3rem)] [border-bottom:1px_solid_var(--border)] [&:last-child]:[border-bottom:0] max-[72.001rem]:[grid-template-columns:2rem_auto_1fr] max-[44.001rem]:[grid-template-columns:auto_1fr]',
  'player-stats':
  ...
  'primary-navigation':
    "[display:flex] [height:100%] [align-items:center] [justify-content:center] [gap:clamp(0.7rem,_1.5vw,_1.5rem)] [&_a]:[border-top:0] [&_a]:[border-right:0] [&_a]:[border-bottom:1px_solid_transparent] [&_a]:[border-left:0] [&_a]:[background:transparent] [&_a]:[color:var(--text-muted)] [&_a]:[font-size:0.77rem] [&_a]:[font-weight:700] [&_a]:[letter-spacing:0.08em] [&_a]:[text-decoration:none] [&_a]:[text-transform:uppercase] [&_a]:[display:flex] [&_a]:[height:100%] [&_a]:[align-items:center] [&_a]:[padding-block:0.75rem] [&_a:first-child]:[border-bottom-color:var(--accent)] [&_a:first-child]:[color:var(--text)] [&_a:hover]:[border-bottom-color:var(--accent)] [&_a:hover]:[color:var(--text)] max-[72.001rem]:[position:absolute] max-[72.001rem]:[top:100%] max-[72.001rem]:[right:0] max-[72.001rem]:[left:0] max-[72.001rem]:[display:none] max-[72.001rem]:[align-items:stretch] max-[72.001rem]:[padding:1rem] max-[72.001rem]:[border-bottom:1px_solid_var(--border-strong)] max-[72.001rem]:[background:var(--surface)] max-[72.001rem]:[box-shadow:var(--shadow)] max-[72.001rem]:[&[data-open='true']]:[display:grid] max-[72.001rem]:[&_a]:[height:auto] max-[72.001rem]:[&_a]:[padding:0.75rem] max-[72.001rem]:[&_a]:[text-align:left]",
  'record-number':
  ...
  'status-pip':
    '[width:0.55rem] [height:0.55rem] [border:1px_solid_var(--success)] [background:var(--success)] [box-shadow:0_0_0_3px_color-mix(in_srgb,_var(--success)_18%,_transparent)]',
  'story-archive':
