...
export function EventsPage() {
  ...
  return (
    <>
      ...
      />
      <div className="page-shell page-content events-archive">
...
function EventGroup({
  ...
  return (
    <section className="event-group" aria-labelledby={title.replace(' ', '-')}>
      ...
      <div className="event-archive-list">
        {events.map((event) => (
          <article className="event-archive-entry" key={event.slug}>
